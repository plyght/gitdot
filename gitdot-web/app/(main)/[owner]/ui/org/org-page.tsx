...
export default function OrgPage({ org }: { org: OrganizationResource }) {
  return (
    <div className="grid grid-cols-[8rem_minmax(0,2fr)_minmax(0,3fr)] h-full">
      ...
      <div className="pt-2 pl-4 pr-3 py-2 border-l flex flex-col min-h-0 overflow-y-auto scrollbar-none text-sm text-muted-foreground">
        <p>
