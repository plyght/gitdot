...
We publicize our roadmap in [/releases](https://gitdot.io/releases) with estimated dates for each. \
While we do think that stands to be pretty complete, if there is something missing, please do [let us know](mailto:founders@gitdot.io).
...
We document major design decisions in the [/designs](https://gitdot.io/designs) folder. \
We chronicle our progress and our thinking in the [/weeks](https://gitdot.io/weeks) folder.
...
[Two dudes](https://gitdot.io/bkdevs) in Brooklyn.
